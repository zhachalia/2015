...
using System.Data;
    ...
    {
        //数据库连接字符串
        public static string ConnStr = ConfigurationManager.ConnectionStrings["con1"].ConnectionString;
        ...
        {
            return ExecuteNonQuery(ConnStr, CommandType.Text, cmdText, commandParameters);
        }
        ...
        {
            return GetDataSet(ConnStr, CommandType.Text, cmdText, commandParameters);
        }

        public static    DataSet GetDataSet(string cmdTexts)
        {
            return GetDataSet(cmdTexts,null);
        }

        public static    DataTable GetDataTable(string cmdText, params MySqlParameter[] commandParameters)
        {
            DataSet ds =  GetDataSet(ConnStr, CommandType.Text, cmdText, commandParameters);
        ...
        public static    DataTable GetDataTable(string cmdTexts)
        {
            return GetDataTable(cmdTexts, null);
        }
        ...
        {
            return ExecuteScalar(ConnStr, CommandType.Text, sql, null);
        }
        ...
        public static int Import(string tableName,string cvsFileName)
        {
            int r = -1;
            using (MySqlConnection cn1 = new MySqlConnection(ConnStr))
            {
                cn1.Open();
        ...
        /// <returns></returns>
        public static int Clear(string tableName)
        {
